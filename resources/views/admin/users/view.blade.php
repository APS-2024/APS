...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Client View</li>
        </ol>
...
@section('content')
                ...
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            @if($user->avatar)
                            <img src="{{ $user->avatar ?? $user->defAvatar($user->id) }}"alt="profile_image" class="w-100 border-radius-lg shadow-sm">
                            @else
  ...
  $role=  $user->hasRole('User');
    ...
    @endphp
@if($role == true)
<form action="{{ route('profile.update', $user->id) }}" method="POST" role="form text-left" enctype="multipart/form-data">
@else
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="card">
                                ...
                                @if($role == true)
                                        <form action="{{ route('profile.othersUpdate', $user->id) }}" method="POST" role="form text-left">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="card">
                                ...
                                @if($role == true)
                                    <form action="{{ route('profile.passUpdate', $user->id) }}" method="POST" role="form text-left">
