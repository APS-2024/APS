...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('public/assets/css/soft-ui-dashboard.css?v=1.0.5') }}" rel="stylesheet" />
    @yield('styles')
</head>
...
<script src="{{ asset('public/assets/js/headtag.js') }}"></script>
...
<script src="{{ asset('public/assets/js/soft-ui-dashboard.min.js?v=1.0.5') }}"></script>
</body>
